...
export const translations = {
  it: {
    ...
    chat: {
      launcher: 'Fai una domanda',
      title: 'Assistente Intini Web Atelier',
      status: 'Online ora',
      greeting: "Ciao. Sono l'assistente di Intini Web Atelier. Posso spiegarti come realizziamo siti su misura per la tua attività e aiutarti a capire da dove partire. Cosa ti serve?",
      placeholder: 'Scrivi la tua domanda...',
      send: 'Invia',
      book: 'Richiedi un preventivo gratuito',
      suggestions: ['Cosa fate esattamente?', 'Quanto costa un sito?', 'In quanto tempo è pronto?'],
      rate: 'Un attimo di pausa, troppe domande di fila. Riprova tra poco oppure richiedi direttamente un preventivo.',
      down: 'Ora non riesco a rispondere. Scrivimi su WhatsApp o a info@intiniwebatelier.com e ti rispondo io.',
      close: 'Chiudi',
    },
  },
  en: {
    ...
    chat: {
      ...
      title: 'Intini Web Atelier Assistant',
      status: 'Online now',
      greeting: 'Hi. I am the Intini Web Atelier assistant. I can explain how we build custom websites for your business and help you figure out where to start. What do you need?',
      placeholder: 'Type your question...',
      send: 'Send',
      book: 'Request a free quote',
      suggestions: ['What exactly do you do?', 'How much does a website cost?', 'How long does it take?'],
      rate: 'Quick pause, too many questions in a row. Try again shortly or request a free quote directly.',
      down: 'I cannot answer right now. Message me on WhatsApp or at info@intiniwebatelier.com and I will reply personally.',
      close: 'Close',
    },
  },
  fr: {
    ...
    chat: {
      launcher: 'Posez une question',
      title: 'Assistant Intini Web Atelier',
      status: 'En ligne',
      greeting: "Bonjour. Je suis l'assistant d'Intini Web Atelier. Je peux vous expliquer comment nous créons des sites sur mesure pour votre activité et vous aider à savoir par où commencer. Que vous faut-il ?",
      placeholder: 'Écrivez votre question...',
      send: 'Envoyer',
      book: 'Demander un devis gratuit',
      suggestions: ['Que faites-vous exactement ?', 'Combien coûte un site ?', 'En combien de temps est-il prêt ?'],
      rate: 'Une petite pause, trop de questions à la suite. Réessayez bientôt ou demandez directement un devis gratuit.',
      down: 'Je ne peux pas répondre pour le moment. Écrivez-moi sur WhatsApp ou à info@intiniwebatelier.com et je vous répondrai personnellement.',
      close: 'Fermer',
    },
  },
  de: {
    ...
    chat: {
      launcher: 'Stellen Sie eine Frage',
      title: 'Intini Web Atelier Assistent',
      status: 'Jetzt online',
      greeting: 'Hallo. Ich bin der Assistent von Intini Web Atelier. Ich erkläre Ihnen gerne, wie wir maßgeschneiderte Websites für Ihr Unternehmen erstellen, und helfe Ihnen beim Einstieg. Was brauchen Sie?',
      placeholder: 'Schreiben Sie Ihre Frage...',
      send: 'Senden',
      book: 'Kostenloses Angebot anfordern',
      suggestions: ['Was genau machen Sie?', 'Was kostet eine Website?', 'Wie lange dauert es?'],
      rate: 'Kurze Pause, zu viele Fragen hintereinander. Versuchen Sie es bald erneut oder fordern Sie direkt ein kostenloses Angebot an.',
      down: 'Ich kann gerade nicht antworten. Schreiben Sie mir auf WhatsApp oder an info@intiniwebatelier.com, und ich antworte Ihnen persönlich.',
      close: 'Schließen',
    },
  },
} as const;
